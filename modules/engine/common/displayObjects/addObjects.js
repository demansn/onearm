import { Graphics, BitmapText, TextStyle } from "pixi.js";
...
ObjectFactory.registerObjectFactory("EngineText", ({ style, text, maxWidth }, factory) => {
    if (style) {
        if (typeof style === "string") {
            ...
            style = new TextStyle(convertV7TextStyle(style, factory));
        }
    }
...
ObjectFactory.registerObjectConstructor("SpineGroup", SpineGroup);
